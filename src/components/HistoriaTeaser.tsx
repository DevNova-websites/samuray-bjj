      ...
      <div style={{ maxWidth: "1100px", margin: "0 auto", position: "relative", zIndex: 1 }}>
        ...
        >
          ...
          <p style={{ fontFamily: "var(--font-inter), sans-serif", fontSize: "1rem", lineHeight: 1.75, color: "rgba(255,255,255,0.75)", marginBottom: "1rem" }}>
            Más de <strong style={{ color: "#FFFFFF" }}>50 años de trayectoria marcial</strong> forjaron la esencia de lo que hoy es la JL Samuray BJJ Academy. Cada hito en el camino del Mestre Samuray Ledesma fue un paso más hacia la construcción de una familia.
          </p>
